...
+-- components/ # presentational components
    +-- Tabs # component that is only used in the package
...
```js
import Tabs, { actions, actionTypes, middleware, reducer } from '@bufferapp/tabs';
```
