# @bufferapp/summary-table

Summary Table package for Insights/Overview
...
+-- components/ # presentational components
    +-- SummaryTable # component that is only used in the package
...
```js
import SummaryTable, { actions, actionTypes, middleware, reducer } from '@bufferapp/summary-table';
```
...
#### components/SummaryTable/index.jsx
...
#### components/SummaryTable/story.jsx
