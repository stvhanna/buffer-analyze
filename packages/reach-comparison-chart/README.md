# @bufferapp/reach-comparison-chart

The reach comparison chart for Analyze
...
+-- components/ # presentational components
    +-- ReachComparisonChart # component that is only used in the package
...
```js
import ReachComparisonChart, { actions, actionTypes, middleware, reducer } from '@bufferapp/reach-comparison-chart';
```
...
#### components/ReachComparisonChart/index.jsx
...
#### components/ReachComparisonChart/story.jsx
