# @bufferapp/contextual-compare

The Contextual Compare Chart for Analyze Overview
...
+-- components/ # presentational components
    +-- COntextualCompare # component that is only used in the package
...
```js
import ContextualCompare, { actions, actionTypes, middleware, reducer } from '@bufferapp/contextual-compare';
```
...
#### components/COntextualCompare/index.jsx
...
#### components/COntextualCompare/story.jsx
