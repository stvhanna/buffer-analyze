# @bufferapp/feature-flip-check

Check for existing feature flip, or redirect back user
...
+-- components/ # presentational components
    +-- FeatureFlipCheck # component that is only used in the package
...
```js
import FeatureFlipCheck, { actions, actionTypes, middleware, reducer } from '@bufferapp/feature-flip-check';
```
...
#### components/FeatureFlipCheck/index.jsx
...
#### components/FeatureFlipCheck/story.jsx
