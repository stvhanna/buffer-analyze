...
describe('middleware', () => {
  ...
  it('shoud dispatch a data fetch for likes comparison once a compare profile has been pressed', () => {
    const action = {
  ...
  it('shoud dispatch a data fetch for likes comparison on date change', () => {
    const action = {
