# @bufferapp/comments-comparison-chart
...
```
comments-comparison-chart/ # root
+-- __snapshots__/
...
+-- components/ # presentational components
    +-- The comments comparison chart for Analyze # component that is only used in the package
...
```js
import CommentsComparisonChart, { actions, actionTypes, middleware, reducer } from '@bufferapp/comments-comparison-chart';
```
...
```
+-- components/
    +-- The comments comparison chart for Analyze/
        `-- index.jsx
        `-- story.jsx
```

#### components/The comments comparison chart for Analyze/index.jsx
...
#### components/The comments comparison chart for Analyze/story.jsx
