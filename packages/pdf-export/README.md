# @bufferapp/pdf-export

PDF Export button &amp; middleware for reports
...
+-- components/ # presentational components
    +-- PDFExportButton # component that is only used in the package
...
```js
import PdfExport, { actions, actionTypes, middleware, reducer } from '@bufferapp/pdf-export';
```
...
#### components/PDFExportButton/index.jsx
...
#### components/PDFExportButton/story.jsx
