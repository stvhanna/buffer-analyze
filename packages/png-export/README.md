...
+-- components/ # presentational components
    +-- ExportButton # component that is only used in the package
...
```js
import PngExport, { actions, actionTypes, middleware, reducer } from '@bufferapp/png-export';
```
...
#### components/ExportButton/story.jsx
