...
+-- components/ # presentational components
    +-- Report # component that is only used in the package
...
```js
import Report, { actions, actionTypes, middleware, reducer } from '@bufferapp/report';
```
