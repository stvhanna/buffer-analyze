# @bufferapp/average-table

average table for insights
...
+-- components/ # presentational components
    +-- AverageTable # component that is only used in the package
...
```js
import AverageTable, { actions, actionTypes, middleware, reducer } from '@bufferapp/average-table';
```
...
#### components/AverageTable/index.jsx
...
#### components/AverageTable/story.jsx
