# @bufferapp/profile-header

The profile header for Insights
...
+-- components/ # presentational components
    +-- ProfileHeader # component that is only used in the package
...
```js
import ProfileHeader, { actions, actionTypes, middleware, reducer } from '@bufferapp/profile-header';
```
...
#### components/ProfileHeader/index.jsx
...
#### components/ProfileHeader/story.jsx
