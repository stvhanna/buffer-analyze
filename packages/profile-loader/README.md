...
Profile Loader wrapper, renders children once the profiles have loaded
...
+-- components/ # presentational components
    +-- ProfileLoader # component that is only used in the package
...
#### components/ProfileLoader/story.jsx
