# @bufferapp/compare-chart

compare daily metrics with the previous period
...
+-- components/ # presentational components
    +-- CompareChart # component that is only used in the package
...
```js
import CompareChart, { actions, actionTypes, middleware, reducer } from '@bufferapp/compare-chart';
```
...
#### components/CompareChart/index.jsx
...
#### components/CompareChart/story.jsx
