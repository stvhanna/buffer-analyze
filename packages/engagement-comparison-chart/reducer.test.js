...
describe('reducer', () => {
  ...
  it('should update metric on fetch success if metric is engagement', () => {
    const metrics = [
      { label: 'foo' },
      { label: 'bar' },
    ];
  ...
  it('should NOT update metric on fetch success if metric is NOT engagement', () => {
    const metrics = [
      { label: 'foo' },
      { label: 'bar' },
    ];
