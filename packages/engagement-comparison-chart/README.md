# @bufferapp/engagement-comparison-chart

The engagement comparison chart for Analyze.
...
```
engagement-comparison-chart/ # root
+-- __snapshots__/
...
+-- components/ # presentational components
    +-- EngagementComparisonChart # component that is only used in the package
...
```js
import EngagementComparisonChart, { actions, actionTypes, middleware, reducer } from '@bufferapp/engagement-comparison-chart';
```
...
#### components/EngagementComparisonChart/index.jsx
...
#### components/EngagementComparisonChart/story.jsx
