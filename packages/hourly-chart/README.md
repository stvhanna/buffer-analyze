# @bufferapp/hourly-chart

Hourly Engagements Chart
...
+-- components/ # presentational components
    +-- HourlyChart # component that is only used in the package
...
```js
import HourlyChart, { actions, actionTypes, middleware, reducer } from '@bufferapp/hourly-chart';
```
...
#### components/HourlyChart/index.jsx
...
#### components/HourlyChart/story.jsx
