# @bufferapp/posts-summary-table

Posts Summary Table package for Insights/Overview
...
+-- components/ # presentational components
    +-- PostsSummaryTable # component that is only used in the package
...
```js
import PostsSummaryTable, { actions, actionTypes, middleware, reducer } from '@bufferapp/posts-summary-table';
```
...
#### components/PostsSummaryTable/index.jsx
...
#### components/PostsSummaryTable/story.jsx
